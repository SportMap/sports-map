...
('Olympia Arena', 'A large outdoor stadium suitable for various sports, including running and team sports.', 'www.olympiaarena.com', 'GRASS', 'LEKKOATLETYKA', 54.361206, 18.658292, 1, FALSE),
('Aqua Sports Center', 'Indoor aquatic center with Olympic-size pools and diving facilities.', 'www.aquasportscenter.com', 'ARTIFICIAL_TURF', 'PŁYWANIE', 54.372158, 18.620951, 2, TRUE),
('Mountain Bike Park', 'Outdoor complex with trails and tracks for mountain biking enthusiasts.', 'www.mountainbikepark.com', 'CLAY', 'SPORTY_SIŁOWE', 54.380570, 18.598446, 3, FALSE),
...
('Green Field Soccer Complex', 'Spacious outdoor fields suitable for football and other team sports.', 'www.greenfieldsoccer.com', 'SYNTHETIC_TRACK', 'PIŁKA_NOŻNA', 54.352025, 18.646638, 5, FALSE);
